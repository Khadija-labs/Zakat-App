...
import { UnderstandingZakatContent } from "@/components/UnderstandingZakatContent";
  ...
  return (
    <Layout>
      ...
      <SEO
        ...
        path="/"
      />
      {/* Hero Section (Al-Zakat banner) */}
      <section className="relative pt-20 pb-28 overflow-hidden bg-slate-300 dark:bg-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <div>
            <h1 className="arabic-text text-7xl md:text-[120px] text-secondary/90 dark:text-secondary-foreground leading-none mb-4 select-none drop-shadow-sm">
              الزكاة
            </h1>
            <h2 className="font-display text-3xl md:text-5xl font-bold text-foreground dark:text-primary mb-6 tracking-tight">
      ...
      {/* Understanding Zakat content (no separate banner) */}
      <UnderstandingZakatContent />
    </Layout>
  );
}
