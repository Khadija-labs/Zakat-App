    ...
    <Layout>
      ...
      <div className="bg-secondary text-white py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/70 font-light">Your financial data is yours alone.</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-card rounded-3xl p-8 md:p-12 shadow-sm border border-border">
          <div className="prose prose-lg max-w-none text-foreground/80">
            ...
            <h2 className="font-display text-2xl font-bold text-secondary mb-4">2. Contact Form Submissions</h2>
            <p className="mb-6">
            ...
            <h2 className="font-display text-2xl font-bold text-secondary mb-4">3. Cookies & Tracking</h2>
            <p className="mb-6">
            ...
            <h2 className="font-display text-2xl font-bold text-secondary mb-4">4. Updates to this Policy</h2>
            <p className="mb-6">
