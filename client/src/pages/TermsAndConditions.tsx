      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-card rounded-3xl p-8 md:p-12 shadow-sm border border-border">
          <div className="prose prose-lg max-w-none text-foreground/80">
            ...
            <h2 className="font-display text-2xl font-bold text-secondary dark:text-primary mb-4">4. Privacy and Data</h2>
            <p className="mb-6">
            ...
            <h2 className="font-display text-2xl font-bold text-secondary dark:text-primary mb-4">5. Use of the Website</h2>
            <p className="mb-6">
            ...
            <h2 className="font-display text-2xl font-bold text-secondary dark:text-primary mb-4">6. Disclaimer of Warranties</h2>
            <p className="mb-6">
            ...
            <h2 className="font-display text-2xl font-bold text-secondary dark:text-primary mb-4">9. Contact</h2>
            <p className="mb-6">
